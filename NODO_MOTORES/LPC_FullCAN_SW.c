...
RETURNS: nothing
***************************************************************************/ 
void FullCAN_CANISR_Err (void) IRQ_KEYWORD
{
...
RETURNS: nothing
***************************************************************************/ 
void FullCAN_CANISR_Rx1 (void) IRQ_KEYWORD
{
unsigned int buf;
unsigned int *pDest;
  ...
  CanRX++;	//activamos flag para la lectura del dato en el bucle principal
...
RETURNS: nothing
***************************************************************************/ 
void FullCAN_CANISR_Rx2 (void) IRQ_KEYWORD 
{
unsigned int buf;
unsigned int *pDest;
...
RETURNS: nothing
***************************************************************************/ 
void FullCAN_CANISR_Rx3 (void) IRQ_KEYWORD 
{
unsigned int buf;
unsigned int *pDest;
...
RETURNS: nothing
***************************************************************************/ 
void FullCAN_CANISR_Rx4 (void) IRQ_KEYWORD 
{
unsigned int buf;
unsigned int *pDest;
